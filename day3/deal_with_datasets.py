...
# 数据集路径
dataset_dir = r'C:\Users\Toni\Desktop\dataset\Images'  # 替换为你的数据集路径
train_dir = r'C:\Users\Toni\Desktop\dataset\Image2\train'  # 训练集输出路径
val_dir = r'C:\Users\Toni\Desktop\dataset\Image2\val'  # 验证集输出路径
